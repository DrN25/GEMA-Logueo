...
// ─── Funciones Auxiliares para Mapeo y Estilo de Clases ──────────────────────
...
function getLithologyClasses(code: string): string[] {
  ...
  LITHOLOGY_K_REFERENCES.forEach(ref => {
    ...
    // Búsqueda jerárquica en cascada: lito3 -> lito2 -> lito1
...
export default function CatalogsModal({ isOpen, onClose }: CatalogsModalProps) {
  const [activeTab, setActiveTab] = useState<'rmr' | 'structural' | 'structures' | 'weathering' | 'filling' | 'jrc' | 'lithology' | 'plt'>('lithology');

  if (!isOpen) return null;

  const tabs = [
    { id: 'lithology', label: 'Litología y Colores', icon: Palette },
    { id: 'structural', label: 'Logueo Estructural', icon: Compass },
    { id: 'rmr', label: 'Parámetros RMR', icon: BookOpen },
    { id: 'structures', label: 'Estructuras', icon: Layers },
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm select-none p-4 animate-fade-in">
      <div className="glass-panel w-full max-w-7xl h-[85vh] rounded-2xl border border-navy-800 flex flex-col overflow-hidden shadow-2xl text-slate-300">
          ...
          {tabs.map(tab => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold transition-all whitespace-nowrap border ${isActive
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-navy-950/20">
          ...
          {activeTab === 'structural' && (
            <div className="glass-panel p-5 rounded-xl border border-navy-800 space-y-4 bg-navy-950/45 max-w-2xl mx-auto animate-fade-in">
              <div className="border-b border-navy-800 pb-3 flex justify-between items-center">
                <div>
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-yellow-500 dark:text-amber-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
                    <span>Resistencia Uniaxial (R76/R89)</span>
                ...
                {/* P2: RQD */}
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-emerald-500 dark:text-emerald-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
                ...
                {/* P3: Espaciamiento */}
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-cyan-500 dark:text-cyan-400 uppercase tracking-wider border-b border-navy-800 pb-1.5">
                ...
                {/* P5: Agua */}
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-blue-500 dark:text-blue-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
              ...
              {/* SECCIÓN: P4 — Valoración de la Condición de Discontinuidades (Sub-parámetros) */}
              <div className="glass-panel p-5 rounded-xl border border-navy-800 space-y-4 bg-navy-950/45">
                <h3 className="text-xs font-bold text-cyan-400 uppercase tracking-widest border-b border-navy-800 pb-2">
                  Condición de Discontinuidades / Juntas
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <table className="w-full text-left border-collapse text-[11px]">
                      <thead>
                        <tr className="text-slate-500 font-bold uppercase border-b border-navy-850">
                          ...
                          <th className="py-1 px-1 text-center text-cyan-400">Rating 89</th>
                          <th className="py-1 px-1 text-center text-yellow-500">Rating 76</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                    ...
                    <table className="w-full text-left border-collapse text-[11px]">
                      <thead>
                        <tr className="text-slate-500 font-bold uppercase border-b border-navy-850">
                          ...
                          <th className="py-1 px-1 text-center text-cyan-400">RMR_89</th>
                          <th className="py-1 px-1 text-center text-yellow-500">RMR_76</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                    ...
                    <table className="w-full text-left border-collapse text-[11px]">
                      ...
                      <tbody>
                        {[
                          ...
                          { code: "W2", name: "Ligeramente Meteorizada", r89: 5, r76: 4 },
                          { code: "W3", name: "Moderadamente meteorizada", r89: 3, r76: 3 },
                          { code: "W4", name: "Altamente Meteorizada", r89: 1, r76: 1 },
                  ...
                  {/* P4.6 — Simbología Logueo Abertura */}
                  <div className="space-y-1.5 bg-navy-900/25 p-3 rounded-lg border border-navy-800/60">
                    <h4 className="text-[11px] font-bold text-slate-200 uppercase tracking-wider border-b border-navy-800 pb-1 block">
                      Abertura (Simbología Logueo)
                    </h4>
                    <table className="w-full text-left border-collapse text-[11px]">
                      <thead>
                        <tr className="text-slate-500 font-bold uppercase border-b border-navy-850">
                          <th className="py-1 px-1">Abertura</th>
                          <th className="py-1 px-1 text-center">Simbología logueo</th>
                          <th className="py-1 px-1 text-center text-cyan-400">Valoración</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
              ...
              {/* RMR Class table */}
              <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider border-b border-navy-800 pb-1.5">
          ...
          {activeTab === 'structures' && (
            <div className="glass-panel p-5 rounded-xl border border-navy-800 space-y-4 bg-navy-950/45 max-w-2xl mx-auto animate-fade-in">
              <h3 className="text-xs font-bold text-slate-300 uppercase tracking-widest border-b border-navy-800 pb-2">
          ...
          {activeTab === 'weathering' && (
            <div className="glass-panel p-5 rounded-xl border border-navy-800 space-y-4 bg-navy-950/45 max-w-3xl mx-auto animate-fade-in">
              <h3 className="text-xs font-bold text-red-500 dark:text-red-400 uppercase tracking-widest border-b border-navy-800 pb-2">
          ...
          {activeTab === 'filling' && (
            <div className="space-y-6 animate-fade-in">
              ...
              {/* Table 2: Minerals classification */}
              <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                <h3 className="text-xs font-bold text-purple-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
          ...
          {/* Nueva Sección: Perfiles Rugosidad (Alineado con el boceto Barton vs ISRM) */}
          {activeTab === 'jrc' && (
            <div className="glass-panel p-5 rounded-xl border border-navy-800 space-y-4 bg-navy-950/45 max-w-4xl mx-auto animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                ...
                {/* Lado Derecho: Perfiles Típicos ISRM (1989) */}
                <div className="space-y-1.5 bg-navy-900/25 p-3 rounded-lg border border-navy-800/60">
                  <h4 className="text-[11px] font-bold text-slate-200 uppercase tracking-wider border-b border-navy-800 pb-1 block">
          ...
          {/* Sección: Litologías y Códigos de Colores con Etiquetas de Clases a la Derecha */}
          {activeTab === 'lithology' && (
                ...
                {Object.entries(LITHOLOGY_CATALOG).map(([code, item]) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Grupo Derecho: Badge / Etiqueta de Clase */}
          ...
          {/* Sección: PLT Referencia (Tabla Dinámica vinculada sin duplicación) */}
          {activeTab === 'plt' && (
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

                {/* Tabla 1: Tipo de Ensayo PLT */}
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-cyan-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
                ...
                {/* Tabla 2: Diámetro de Perforación */}
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-blue-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
                ...
                {/* Tabla 3: Tipo de Rotura */}
                <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                  <h3 className="text-xs font-bold text-amber-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
              ...
              {/* Tabla 5: Clasificación UCS */}
              <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                <h3 className="text-xs font-bold text-emerald-400 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
              ...
              {/* Tabla 6: Litología y Factor K */}
              <div className="glass-panel p-4 rounded-xl border border-navy-800 space-y-3 bg-navy-950/45">
                <h3 className="text-xs font-bold text-slate-300 uppercase tracking-wider border-b border-navy-800 pb-1.5 flex justify-between">
                ...
                <div className="max-h-[300px] overflow-y-auto pr-1">
                  <table className="w-full text-left border-collapse text-xs">
                    <thead className="sticky top-0 bg-navy-950 z-10">
                      <tr className="text-slate-500 font-bold uppercase border-b border-navy-850 bg-navy-950">
