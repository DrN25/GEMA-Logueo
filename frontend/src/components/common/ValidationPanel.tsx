                ...
                <div className="flex gap-2.5 items-start">
                  ...
                  <div className="space-y-2 flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-1.5 items-center">
                      ...
                      {/* Tab badge */}
                      <span className="inline-flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full bg-slate-800/70 border border-slate-700/60 text-slate-300">
                        <MapPin size={10} className="text-cyan-400 shrink-0" />
                        {context.tab}
                      </span>
                      {/* Column badge */}
                      <span className="inline-flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300">
