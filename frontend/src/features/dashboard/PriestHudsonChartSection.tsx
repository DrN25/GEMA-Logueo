...
const PhTooltip = ({ hoveredPoint }: { hoveredPoint: any }) => {
...
const PriestHudsonChartSection = React.memo(({
  scatterPh,
  phSuaveLine,
  lithologyZones,
  rqdBinsData,
...
export default PriestHudsonChartSection;
