...
export default function KpiMetrics({
  ...
  return (
    <div className="space-y-6">
      ...
      {kpis.familia1 && (
        <div className="rounded-xl border border-cyan-500/10 bg-[#090f1d]/50 p-5 grid grid-cols-1 md:grid-cols-3 gap-6 shadow-md shadow-[0_0_20px_rgba(6,182,212,0.01)]">
          ...
          <div className="rounded-xl border border-navy-800 bg-[#090f1d]/50 p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
              <div className="bg-[#10b981]/5 border border-[#10b981]/20 p-4 rounded-xl text-center shadow-inner">
                <span className="text-xs font-black text-slate-500 uppercase block">Celdas OK</span>
