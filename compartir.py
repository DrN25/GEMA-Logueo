...
def main():
    ...
    try:
        ...
        backend_proc = subprocess.Popen(
            f'start "GeoLog Pro 2.0 - Backend (FastAPI)" cmd /k "{backend_cmd}"',
            shell=True
        )
        ...
        frontend_proc = subprocess.Popen(
            f'start "GeoLog Pro 2.0 - Frontend (React + Vite)" cmd /k "{frontend_cmd}"',
            shell=True
        )
        
        print("\n=======================================================================")
        print("               GeoLog Pro 2.0 — COMPARTIDO CON CLOUDFLARE")
        print("=======================================================================")
